 ...
 * @author (YD)
 * @version (1.0)
 * @ProjectName CommonViewHolderHelper
 * @Title: CommonViewHolderHelper.java
 * @Package com.custom.libs.adapter.viewhold
 * @Description: TODO(为AdapterView和RecyclerView的item设置常见属性（链式编程）)
 * @date 2016/1/28
 * @time 16:12
 */

public class CommonViewHolderHelper  implements View.OnClickListener, View.OnLongClickListener, CompoundButton.OnCheckedChangeListener {
        ...
        protected CommonRecyclerViewHolder mRecyclerViewHolder;
        ...
        public CommonViewHolderHelper(ViewGroup adapterView, View convertView) {
        ...
        public CommonViewHolderHelper(RecyclerView recyclerView, View convertView) {
            mViews = new SparseArray<>();
    ...
    public void setRecyclerViewHolder(CommonRecyclerViewHolder recyclerViewHolder) {
        mRecyclerViewHolder = recyclerViewHolder;
    }

    public CommonRecyclerViewHolder getRecyclerViewHolder() {
     ...
     * @return
     */
    public CommonViewHolderHelper setText(@IdRes int viewId, CharSequence text) {
     ...
     * @return
     */
    public CommonViewHolderHelper setText(@IdRes int viewId, @StringRes int stringResId) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public CommonViewHolderHelper setHtml(@IdRes int viewId, String source) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public CommonViewHolderHelper setChecked(@IdRes int viewId, boolean checked) {
        Checkable view = getView(viewId);
        view.setChecked(checked);
        return this;
    }

    public CommonViewHolderHelper setTag(@IdRes int viewId, Object tag) {
        View view = getView(viewId);
        view.setTag(tag);
        return this;
    }

    public CommonViewHolderHelper setTag(@IdRes int viewId, int key, Object tag) {
        View view = getView(viewId);
        view.setTag(key, tag);
        return this;
    }

    public CommonViewHolderHelper setVisibility(@IdRes int viewId, int visibility) {
        View view = getView(viewId);
        view.setVisibility(visibility);
        return this;
    }

    public CommonViewHolderHelper setImageBitmap(@IdRes int viewId, Bitmap bitmap) {
        ImageView view = getView(viewId);
        view.setImageBitmap(bitmap);
        return this;
    }

    public CommonViewHolderHelper setImageDrawable(@IdRes int viewId, Drawable drawable) {
        ImageView view = getView(viewId);
     ...
     * @return
     */
    public CommonViewHolderHelper setTextColorRes(@IdRes int viewId, @ColorRes int textColorResId) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public CommonViewHolderHelper setTextColor(@IdRes int viewId, int textColor) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public CommonViewHolderHelper setBackgroundRes(@IdRes int viewId, int backgroundResId) {
        View view = getView(viewId);
     ...
     * @return
     */
    public CommonViewHolderHelper setBackgroundColor(@IdRes int viewId, int color) {
        View view = getView(viewId);
     ...
     * @return
     */
    public CommonViewHolderHelper setBackgroundColorRes(@IdRes int viewId, @ColorRes int colorResId) {
        View view = getView(viewId);
     ...
     * @return
     */
    public CommonViewHolderHelper setImageResource(@IdRes int viewId, @DrawableRes int imageResId) {
        ImageView view = getView(viewId);
