 ...
 * @author (YD)
 * @version (1.0)
 * @ProjectName TerminalUtils
 * @Title: TerminalUtils.java
 * @Package com.custom.libs.utils.sys
 * @Description: TODO(终端的工具类)
 * @date 2016/3/15
 * @time 11:16
 */
public class TerminalUtils {
    ...
    public static boolean appIsForeground(Context context) {
        ...
        List<ActivityManager.RunningTaskInfo> tasksInfo = activityManager.getRunningTasks(2);
