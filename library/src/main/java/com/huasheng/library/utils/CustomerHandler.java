 ...
 * and GC could collect them once CustomerHandler instance is not referenced any more
 * <p>
 *
...
public class CustomerHandler {
     ...
     */
    public CustomerHandler(@Nullable Handler.Callback callback) {
     ...
     */
    public CustomerHandler(@NonNull Looper looper) {
        mCallback = null;
     ...
     * @param callback The callback interface in which to handle messages, or null.
     */
    public CustomerHandler(@NonNull Looper looper, @NonNull Handler.Callback callback) {
        mCallback = callback;
